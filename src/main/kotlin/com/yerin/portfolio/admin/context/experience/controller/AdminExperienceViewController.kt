package com.yerin.portfolio.admin.context.experience.controller

import com.yerin.portfolio.admin.context.experience.service.AdminExperienceService
import com.yerin.portfolio.admin.data.FormElementDTO
import com.yerin.portfolio.admin.data.SelectFormElementDTO
import com.yerin.portfolio.admin.data.TextFormElementDTO
...
class AdminExperienceViewController (
    ...
    fun experience(model: Model): String {
        ...
        val formElements = listOf<FormElementDTO>(
            ...
            SelectFormElementDTO("isActive", 3, listOf(true.toString(), false.toString()))
        )
